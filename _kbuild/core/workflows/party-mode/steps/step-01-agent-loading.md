...
- Agent manifest CSV is available at `{project-root}/_kbuild/_config/agent-manifest.csv`
...
"Now initializing **Party Mode** with our complete kBuild agent roster! Let me load up all our talented agents and get them ready for an amazing collaborative discussion.

**Agent Manifest Loading:**"

Load and parse the agent manifest CSV from `{project-root}/_kbuild/_config/agent-manifest.csv`
...
Welcome {{user_name}}! I'm excited to facilitate an incredible multi-agent discussion with our complete kBuild team. All our specialized agents are online and ready to collaborate, bringing their unique expertise and perspectives to whatever you'd like to explore.
...
"**Agent roster loaded successfully!** All our kBuild experts are excited to collaborate with you.
