...
- Frame Expert : Technical flowcharts, architecture diagrams, wireframes
- Presentation Master (CIS): Pitch decks, creative visuals, Rube Goldberg machines
- Tech Writer : Documentation diagrams, concept explanations
...
helpers: '{project-root}/_kbuild/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/_kbuild/core/resources/excalidraw/validate-json-instructions.md'
```
