...
<critical>The workflow execution engine is governed by: {project-root}/_kbuild/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: {project-root}/_kbuild/cis/workflows/innovation-strategy/workflow.yaml</critical>
