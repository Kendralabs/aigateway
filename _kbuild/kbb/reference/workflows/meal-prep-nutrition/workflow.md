...
Load and read full config from {project-root}/_kbuild/core/config.yaml and resolve:
...
Load, read the full file and then execute `{project-root}/_kbuild/kbb/reference/workflows/meal-prep-nutrition/steps/step-01-init.md` to begin the workflow.
