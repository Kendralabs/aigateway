...
# Path Definitions
workflow_path: '{project-root}/_kbuild/kbb/reference/workflows/meal-prep-nutrition'
...
- IF P: Execute `{project-root}/_kbuild/core/workflows/party-mode/workflow.md` with a chef and dietitian expert also as part of the party
