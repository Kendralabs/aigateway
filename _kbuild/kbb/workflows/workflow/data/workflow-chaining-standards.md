...
**Example:** Kendra Build - Idea to Implementation
...
```yaml
# In KBGD narrative workflow
## INPUT REQUIREMENTS:

### Required:
- {kbuild_output_folder}/prd-{project_name}.md
- {kbuild_output_folder}/architecture-{project_name}.md

### From KBGD:
- {kbgd_output_folder}/gdd-{project_name}.md (Game Design Document)
```
