...
- Part of a specific module (e.g., KBB)
- Has access to module-specific variables
- Stored in module's workflows directory

**KBB additional variable:** `{kbb_creations_output_folder}`
...
**Module:**
"Is this workflow standalone or part of a specific module (KBB, Kendra Build, CIS, KBGD)?"
