...
**Example:** Kendra Build pipeline - each of these are a workflow with many steps:
```
...
- {kbuild_creations_output_folder}/prd-*.md
...
- {kbuild_creations_output_folder}/research-*.md
