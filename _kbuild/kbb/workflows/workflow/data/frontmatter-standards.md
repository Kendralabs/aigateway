...
| ----------------- | -------------------------------------- |
| `{project-root}`  | `/Users/user/dev/kbuild`          |
| `{project_name}`  | `my-project`                            |
| `{output_folder}` | `/Users/user/dev/kbuild/output`    |
| `{user_name}`     | `Brian`                                 |
...
**KBB Module example:**
```yaml
kbb_creations_output_folder: '{project-root}/_kbuild/kbb-creations'
```
...
nextStepFile: '{project-root}/_kbuild/kbuild/workflows/foo/steps/step-02.md'
...
```yaml
---
targetWorkflowPath: '{kbb_creations_output_folder}/workflows/{workflow_name}'
---
