...
Load and read full config from {project-root}/_kbuild/kbb/config.yaml and resolve:

- `project_name`, `output_folder`, `user_name`, `communication_language`, `document_output_language`, `kbb_creations_output_folder`
- ✅ YOU MUST ALWAYS SPEAK OUTPUT In your Agent communication style with the config `{communication_language}`
...
"Welcome to the KBUILD Workflow Creator! What would you like to do?
...
**[C]onvert existing** - Convert an existing workflow to KBUILD compliant format
