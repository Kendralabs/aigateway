...
workflowPlanFile: '{kbb_creations_output_folder}/workflows/{new_workflow_name}/workflow-plan-{new_workflow_name}.md'
kbbCreationsOutputFolder: '{kbb_creations_output_folder}'
...
**Module-Based (KBB, Kendra Build, CIS, KBGD, etc.):**
...
- **KBB** - Module building workflows
- **Kendra Build** - Software development workflows (PRDs, architecture, etc.)
- **CIS** - Innovation and creative workflows
- **KBGD** - Game development workflows
...
- Look for folder at `{kbb_creationsOutputFolder}/workflows/{proposed-name}/`
...
- Typically: `_kbuild/custom/src/workflows/{workflow-name}/`
...
- IF A: Execute {project-root}/_kbuild/core/workflows/advanced-elicitation/workflow.xml
- IF P: Execute {project-root}/_kbuild/core/workflows/party-mode/workflow.md
