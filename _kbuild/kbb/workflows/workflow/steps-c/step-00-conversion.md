...
description: 'Convert existing workflow to KBUILD compliant format by reading all instructions and extracting plan'
...
Convert an existing workflow (any format) to KBUILD compliant format by fully reading and understanding every instruction, extracting the essence, and creating a plan document.
...
"I can help you convert an existing workflow to KBUILD compliant format.
...
{List what's missing for KBUILD compliance}
```
