...
editPlan: '{kbb_creations_output_folder}/edit-plan-{workflow_name}.md'
...
Load the target workflow, check if it follows KBUILD step-file architecture, check for existing validation report, and offer to run validation if needed.
...
**Determine if workflow is KBUILD-compliant:**
...
I found that this workflow does not follow KBUILD step-file architecture:
...
This workflow follows KBUILD step-file architecture:
- ✅ workflow.md found
