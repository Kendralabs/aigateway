# KBUILD Workflow Step Template

This template provides the standard structure for all KBUILD workflow step files. Copy and modify this template for each new step you create.
...
workflow\*path: '{project-root}/_kbuild/[module]/reference/workflows/[workflow-name]' # the folder the workflow.md file is in
...
See [step-01-init.md](https://github.com/kbuild-org/kbuild/blob/main/src/modules/kbb/reference/workflows/meal-prep-nutrition/steps/step-01-init.md) for an example of:
...
See [step-01b-continue.md](https://github.com/kbuild-org/kbuild/blob/main/src/modules/kbb/reference/workflows/meal-prep-nutrition/steps/step-01b-continue.md) for an example of:
...
See [step-02-profile.md](https://github.com/kbuild-org/kbuild/blob/main/src/modules/kbb/reference/workflows/meal-prep-nutrition/steps/step-02-profile.md) for an example of:
...
See [step-06-prep-schedule.md](https://github.com/kbuild-org/kbuild/blob/main/src/modules/kbb/reference/workflows/meal-prep-nutrition/steps/step-06-prep-schedule.md) for an example of:
