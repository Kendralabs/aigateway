# KBUILD Workflow Step 1B Continuation Template
...
workflow\*path: '{project-root}/_kbuild/[module-path]/workflows/[workflow-name]'
...
- `[module-path]` - e.g., "kbb/reference" or "custom"
