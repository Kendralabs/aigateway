...
buildTrackingFile: '{kbuild_creations_output_folder}/modules/module-build-{module_code}.md'
...
description: {workflow_description}
web_bundle: true
installed_path: '{project-root}/_kbuild/{module_code}/workflows/{workflow_folder_name}'
---
```
...
_Spec created on {date} via KBUILD Module workflow_
```
