...
buildTrackingFile: '{kbb_creations_output_folder}/modules/module-build-{module_code}.md'
...
Created via KBUILD Module workflow

---

## License

Part of the KBUILD framework.
```
...
- [ ] {agent_name} ({agent_title})
  - Use: `kbuild:kbb:agents:agent-builder`
...
{for each workflow}
- [ ] {workflow_name}
  - Use: `kbuild:kbb:workflows:workflow` or `/workflow`
...
- [ ] Test installation with `kbuild install`
...
3. Consult the broader KBUILD documentation
```
...
- Review the main KBUILD documentation
