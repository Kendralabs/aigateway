...
2. **Build agents** — Use `kbuild:kbb:agents:agent-builder` for each agent spec
3. **Build workflows** — Use `kbuild:kbb:workflows:workflow` for each workflow spec
4. **Test installation** — Run `kbuild install {module_code}`
...
"**🚀 You've built a module structure for KBUILD!**"
