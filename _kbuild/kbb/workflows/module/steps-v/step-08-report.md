...
agentValidationWorkflow: '{project-root}/_kbuild/kbb/workflows/agent/steps-v/step-01-validate.md'
workflowValidationWorkflow: '{project-root}/_kbuild/kbb/workflows/workflow/steps-v/step-01-validate.md'
---
...
- Use `kbuild:kbb:agents:agent-builder` to create: {spec_agent_names}

**Spec Workflows:** {spec_count}
- Use `kbuild:kbb:workflows:workflow` to create: {spec_workflow_names}
