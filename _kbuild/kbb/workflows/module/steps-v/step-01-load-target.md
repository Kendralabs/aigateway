...
validationReportOutput: '{kbb_creations_output_folder}/modules/validation-report-{target_code}-{timestamp}.md'
---
...
**IF Brief:**
- Path: `{kbb_creations_output_folder}/modules/module-brief-{code}.md`
