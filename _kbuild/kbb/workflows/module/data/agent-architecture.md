...
## Flagship Example: Kendra Build Agent Team

Kendra Build demonstrates a multi-agent module with **9 specialized agents** forming a complete software development team.

### The Kendra Build Theme

**"Agile software delivery, AI-driven"**

Every agent serves this theme — they're a complete team working together.

### Kendra Build Agent Overview
...
- **Kendra Build is the reference** — look at how their agents form a cohesive team
