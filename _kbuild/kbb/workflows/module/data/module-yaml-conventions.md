...
`module.yaml` is the configuration file for a KBUILD module. It:
...
|-------------|------------------|---------|
| Core/Primary | `true` | Kendra Build (agile software delivery) |
| Specialized | `false` | CIS (creative innovation), KBGD (game dev) |
...
### Kendra Build — Complex Configuration

```yaml
code: kbuild
name: "Kendra Build: Kendra Build Agile-AI Driven-Development"
header: "Kendra Build™: AI-Driven Agile Development"
...
### KBGD (Game Development) — Multi-Select Example

```yaml
code: kbgd
name: "KBGD: Kendra Build Game Development"
header: "Kendra Build Game Development Module"
...
1. Run `kbuild install` in a test project
