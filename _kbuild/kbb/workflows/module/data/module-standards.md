...
**Purpose:** Defines what a KBUILD module is, its structure, and the three types of modules.

---

## What is a KBUILD Module?

A **KBUILD module** is a self-contained package of functionality that extends the KBUILD framework. Modules provide:
...
Extends an existing KBUILD module with additional functionality.
...
**Example:** An extension to Kendra Build that adds specialized security review workflows
...
```yaml
# Base module: src/modules/kbuild/module.yaml
code: kbuild

# Extension: src/modules/kbuild/extensions/security/module.yaml
code: kbuild  # SAME CODE — extends Kendra Build
```

The **folder name** is unique (e.g., `kbuild-security`) but the `code:` matches the base module.
...
Affects the entire KBUILD framework and all modules.
...
**Example:** A module that provides universal logging or telemetry across KBUILD
...
- **kebab-case** (e.g., `kbuild`, `cis`, `kbgd`, `healthcare-ai`)
