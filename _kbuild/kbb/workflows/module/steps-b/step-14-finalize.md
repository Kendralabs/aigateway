...
Create the final module brief document and save it to the kbb-creations output folder.
...
Save to: `{kbbCreationsOutputFolder}/modules/module-brief-{module_code}.md`
