...
"**Before we go further, we need to decide: What type of module is this?** This decision affects where files go, how installation works, and how the module integrates with KBUILD."
...
**Extension Module:**
- Extends an existing KBUILD module
- Shares the base module's code (e.g., `code: kbuild`)
- Adds or overrides agents/workflows
- Example: A security extension for Kendra Build

**Global Module:**
- Affects the entire KBUILD framework
...
"Folder name will be unique: {e.g., kbuild-security}"
