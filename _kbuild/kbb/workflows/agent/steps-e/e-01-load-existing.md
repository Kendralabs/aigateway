...
editPlan: '{kbb_creations_output_folder}/edit-plan-{agent-name}.md'
...
If the module property of the agent is a module code (like kbuild, kbb, etc...) it is a module agent.
...
- module: {stand-alone|kbuild|cis|kbgd|custom}
