...
outputFile: {kbb_creations_output_folder}/agent-completion-{agent_name}.md
...
installationDocs: 'https://github.com/kbuild-org/kbuild/blob/main/docs/modules/kbb-kbuild-builder/custom-content-installation.md#standalone-content-agents-workflows-tasks-tools-templates-prompts'
validationWorkflow: '{project-root}/src/modules/kbb/workflows/agent/steps-v/v-01-load-review.md'
---
...
"To make your agent installable and sharable, you'll need to package it as a standalone KBUILD content module. Here's what you need to know:"
...
- **New projects:** The KBUILD installer will prompt for local custom modules
- **Existing projects:** Use "Modify KBUILD Installation" to add your module
...
📖 **[KBUILD Custom Content Installation Guide]({installationDocs})**
...
5. Install via KBUILD installer
```
...
**Final Achievement:**
"You've successfully created a custom KBUILD agent from concept to installation-ready configuration. The journey from idea to deployable agent is complete!"
