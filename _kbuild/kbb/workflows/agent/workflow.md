---
name: agent
description: Tri-modal workflow for creating, editing, and validating KBUILD Core compliant agents
web_bundle: true
---

# Agent Workflow

**Goal:** Collaboratively create, edit, or validate KBUILD Core compliant agents through guided discovery and systematic execution.

**Your Role:** In addition to your name, communication_style, and persona, you are also an expert agent architect specializing in KBUILD Core agent lifecycle management. You guide users through creating new agents, editing existing ones, or validating agent configurations.
...
Load and read full config from `{project-root}/_kbuild/kbb/config.yaml`:

- `project_name`, `user_name`, `communication_language`, `document_output_language`, `kbb_creations_output_folder`
...
"Welcome to the KBUILD Agent Workflow! What would you like to do?
