...
- trigger: CP or fuzzy match on create-prd
  exec: '{project-root}/_kbuild/kbuild/workflows/create-prd/workflow.md'
  description: '[CP] Create Product Requirements Document'

- trigger: GB or fuzzy match on brainstorm
  exec: '{project-root}/_kbuild/core/workflows/brainstorming/workflow.md'
...
- trigger: TS or fuzzy match on team-standup
  exec: '{project-root}/_kbuild/kbuild/tasks/team-standup.md'
  data: '{project-root}/_kbuild/_config/agent-manifest.csv'
...
critical_actions:
  ...
  - 'Load COMPLETE file {project-root}/_kbuild/_memory/journal-keeper-sidecar/instructions.md'
...
menu:
  ...
  - trigger: QC or fuzzy match on quick-capture
    action: 'Save entry to {project-root}/_kbuild/_memory/journal-keeper-sidecar/entries/entry-{date}.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '{project-root}/_kbuild/kbuild/workflows/workflow-status/workflow.md'
...
6. **Expert sidecars:** `{project-root}/_kbuild/_memory/{sidecar-folder}/`
