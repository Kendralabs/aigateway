...
Validate Module agents meet KBUILD quality standards.
...
- [ ] Designed FOR specific module (Kendra Build, KBGD, CIS, or other existing module)
...
- [ ] Workflow paths use: `{project-root}/_kbuild/{module-code}/workflows/...`
...
- [ ] Has sidecar folder
- [ ] Uses `exec:` for workflow references
- [ ] Sidecar paths use `{project-root}/_kbuild/_memory/{sidecar-folder}/` format
...
- [ ] Compare with reference: `security-engineer.agent.yaml` (Kendra Build example)
...
- [ ] Format: `{project-root}/_kbuild/{module-code}/workflows/{workflow-name}/workflow.{md|yaml}`
- [ ] Module codes: `kbuild`, `kbgd`, `cis`, or custom module
- [ ] Paths are case-sensitive and match actual file structure

### Core Workflow Paths

- [ ] Format: `{project-root}/_kbuild/core/workflows/{workflow-name}/workflow.{md|yaml}`
...
**Fix:** `module: stand-alone` (with hyphen) OR actual module code like `kbuild`

### Issue: Hardcoded Workflow Path

**Wrong:** `exec: '../../../kbuild/workflows/create-prd/workflow.md'`

**Fix:** `exec: '{project-root}/_kbuild/kbuild/workflows/create-prd/workflow.md'`

### Issue: Action Instead of Exec for Workflows

**Wrong:** `action: '{project-root}/_kbuild/.../workflow.md'`

**Fix:** `exec: '{project-root}/_kbuild/.../workflow.md'`
