...
- Sidecar created next to agent.yaml during BUILD, then copied to `_memory/` during KBUILD INSTALLATION
- Use `{project-root}/_kbuild/_memory/{sidecar-folder}/` format for RUNTIME paths in agent YAML
...
| Type | Pattern |
|------|---------|
| Expert sidecar | `{project-root}/_kbuild/_memory/{sidecar-folder}/file.md` |
