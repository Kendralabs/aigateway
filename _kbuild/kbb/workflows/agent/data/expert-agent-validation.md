...
Validate Expert agents meet KBUILD quality standards.
...
- [ ] `agent.metadata.module` is `stand-alone` or module code (`kbuild`, `cis`, `kbgd`, etc.)
...
- [ ] **Loads sidecar memories:** `{project-root}/_kbuild/_memory/{sidecar-folder}/memories.md`
- [ ] **Loads sidecar instructions:** `{project-root}/_kbuild/_memory/{sidecar-folder}/instructions.md`
- [ ] **Restricts file access:** `ONLY read/write files in {project-root}/_kbuild/_memory/{sidecar-folder}/`
...
- [ ] ALL sidecar paths use: `{project-root}/_kbuild/_memory/{sidecar-folder}/...`
...
- [ ] References from agent YAML to sidecar use `{project-root}/_kbuild/_memory/` format
...
**Fix:** `{project-root}/_kbuild/_memory/journal-keeper-sidecar/memories.md`
