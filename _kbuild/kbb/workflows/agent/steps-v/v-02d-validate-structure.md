...
validationReport: '{kbb_creations_output_folder}/validation-report-{agent-name}.md'
...
Validate the agent's YAML structure and completeness against KBUILD standards as defined in agentCompilation.md. Append findings to validation report and auto-advance.
...
**For Module Agents (module is a module code like 'kbuild', 'kbb', etc.):**
- [ ] Module property is valid module code
- [ ] Exec paths for menu handlers start with `{project-root}/_kbuild/{module}/...`
