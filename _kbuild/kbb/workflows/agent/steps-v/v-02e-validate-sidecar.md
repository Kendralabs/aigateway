...
Validate the agent's sidecar structure (if Expert type) against KBUILD standards as defined in expertValidation.md. Append findings to validation report and auto-advance.
