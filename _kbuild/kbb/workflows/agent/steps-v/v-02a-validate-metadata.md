...
Validate the agent's metadata properties against KBUILD standards as defined in agentMetadata.md. Append findings to validation report and auto-advance.
